...
import t3hchat.thaivh.com.t3hchat.adapter.ListFriendsAdapter;
import t3hchat.thaivh.com.t3hchat.base.BaseFragment;
import t3hchat.thaivh.com.t3hchat.config.StaticConfig;
import t3hchat.thaivh.com.t3hchat.model.Friend;
...
public class FriendsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String ACTION_DELETE_FRIEND = "com.android.t3hchat.DELETE_FRIEND";
    ...
    public void initLizeComponent() {
        ...
        recyclerListFrends =  rootView.findViewById(R.id.recycleListFriend);
